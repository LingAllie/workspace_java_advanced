            ...
            switch (choice) {
                case 1:
                    ...
                    for (DetailDepartment detailDepartment : detailDepartments) {
                        System.out.println("Department ID" + detailDepartment.getDepartmentId()
                                + " - Address ID" + detailDepartment.getAddress().getAddressId()
                                + " - Emulation point " + detailDepartment.getEmulationPoint());
                    }
                    break;
    ...
    public static void QuestionProgram() {
        ...
        do {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    if (id == 0) {
                        for (Question question: questions) {
                            System.out.println("Question " + question.getQuestionId() + " has list exams: ");
                        ...
                        for (Question question: questions) {
                            if (question.getQuestionId() == id) {
                                System.out.println("Question " + id + " has list exams: ");
                                for (Exam exam : question.getExams()) {
                                    System.out.println(exam);
                                }
                                break;
                ...
                case 4:
                    // Get question by ID
                    id = ScannerUtils.inputNumShort("Enter question ID: ");
        ...
        do {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    if (id == 0) {
                        for (Exam exam: exams) {
                            System.out.println("Exam " + exam.getExamId() + " has list questions: ");
                        ...
                        for (Exam exam: exams) {
                            if (exam.getExamId() == id) {
                                System.out.println("Exam " + id + " has list questions: ");
                                for (Question question : exam.getQuestions()) {
                                    System.out.println(question);
                                }
                                break;
                ...
                case 4:
                    // Get exam by ID
                    id = ScannerUtils.inputNumShort("Enter exam ID: ");
